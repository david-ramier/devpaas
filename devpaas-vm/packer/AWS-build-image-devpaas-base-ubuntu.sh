...
#
# to run:         sh AWS-build-image-devpaas-base-ubuntu.sh amazon-ebs \
#
########################################################################
...
if [ -e ./packer_logs/AWS-packer-jenkins-ubuntu.log ]
then
    echo "Delete the log file of a previous run ..."
    rm -f ./packer_logs/AWS-packer-jenkins-ubuntu.log
fi
