...
#
# to run:         sh VBOX-build-image-devpaas-nexus2-ubuntu.sh virtualbox-iso
#
########################################################################
...
export PACKER_LOG=1
export PACKER_LOG_PATH="./packer_logs/VBOX-packer-devpass-nexus2-ubuntu.log"
...
packer build -force -only=$PACKER_PROVIDERS_LIST  $DEBUG            \
        ...
        images/nexus/packer-nexus2-ubuntu.json
